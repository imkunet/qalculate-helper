...
// "now", "today", "yesterday", etc. all depend on the openat syscall. I've
// opted to instead get the time before seccomping and then return it by
// replacing these two functions. This does seem dirty and requires an extra
// linker flag when doing a static link, but it does work.
